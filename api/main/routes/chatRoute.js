...
router.get('/get-last-messages', isAuth, withUser, async (req, res) => {
	try {
...
router.get('/get-chat-list', isAuth, withUser, async (req, res) => {
...
router.post('/create-private-chat', isAuth, withUser, async (req, res) => {
